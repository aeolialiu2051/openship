...
export const STARTER_TEMPLATES = {
  nextjs: {
    ...
    files: {
      ...
      "app/page.jsx": "export default function Page() { return <main><h1>Next.js Starter</h1><p>Your Vibrail project is ready.</p></main>; }\n",
  ...
  astro: {
    ...
    files: {
      ...
      "src/pages/index.astro": `---\nconst title = "Astro Starter";\n---\n${htmlShell("{title}", "Your Vibrail project is ready.")}`,
    },
  },
  vite: {
    name: "vite-starter",
    ...
    files: {
      ...
      "index.html": htmlShell("Vite Starter", "Your Vibrail project is ready."),
    },
  },
  express: {
    ...
    files: {
      ...
      "index.js": "const express = require('express');\nconst app = express();\nconst port = Number(process.env.PORT || 3000);\napp.get('/', (_req, res) => res.type('html').send('<h1>Express Starter</h1><p>Your Vibrail project is ready.</p>'));\napp.listen(port, '0.0.0.0', () => console.log(`Listening on ${port}`));\n",
    },
  },
  koa: {
    name: "koa-starter",
    ...
    files: {
      ...
      "index.js": "const Koa = require('koa');\nconst app = new Koa();\nconst port = Number(process.env.PORT || 3000);\napp.use((ctx) => { ctx.type = 'html'; ctx.body = '<h1>Koa Starter</h1><p>Your Vibrail project is ready.</p>'; });\napp.listen(port, '0.0.0.0', () => console.log(`Listening on ${port}`));\n",
    },
  },
  node: {
    name: "node-starter",
    ...
    files: {
      ...
      "index.js": "const http = require('node:http');\nconst port = Number(process.env.PORT || 3000);\nhttp.createServer((_req, res) => { res.setHeader('content-type', 'text/html'); res.end('<h1>Node.js Starter</h1><p>Your Vibrail project is ready.</p>'); }).listen(port, '0.0.0.0', () => console.log(`Listening on ${port}`));\n",
    },
  },
  go: {
    name: "go-starter",
    ...
    files: {
      "go.mod": "module app\n\ngo 1.23\n",
      "main.go": "package main\n\nimport (\"fmt\"; \"net/http\"; \"os\")\n\nfunc main() { port := os.Getenv(\"PORT\"); if port == \"\" { port = \"8080\" }; http.HandleFunc(\"/\", func(w http.ResponseWriter, _ *http.Request) { fmt.Fprint(w, \"<h1>Go Starter</h1><p>Your Vibrail project is ready.</p>\") }); fmt.Println(http.ListenAndServe(\":\"+port, nil)) }\n",
    },
  },
  rust: {
    name: "rust-starter",
  ...
  flask: {
    ...
    files: {
      ...
      "app.py": "from flask import Flask\napp = Flask(__name__)\n@app.get('/')\ndef index():\n    return '<h1>Flask Starter</h1><p>Your Vibrail project is ready.</p>'\n",
    },
  },
  fastapi: {
    ...
    files: {
      ...
      "main.py": "from fastapi import FastAPI\nfrom fastapi.responses import HTMLResponse\napp = FastAPI()\n@app.get('/', response_class=HTMLResponse)\ndef index():\n    return '<h1>FastAPI Starter</h1><p>Your Vibrail project is ready.</p>'\n",
    },
  },
  django: {
    name: "django-starter",
  ...
  sinatra: {
    ...
    files: {
      ...
      "app.rb": "require 'sinatra'\nset :bind, '0.0.0.0'\nset :port, ENV.fetch('PORT', '4567')\nget('/') { '<h1>Sinatra Starter</h1><p>Your Vibrail project is ready.</p>' }\n",
    },
  },
  springboot: {
  ...
  dotnet: {
    ...
    files: {
      ...
      "Program.cs": "var builder = WebApplication.CreateBuilder(args);\nvar app = builder.Build();\napp.MapGet(\"/\", () => Results.Content(\"<h1>.NET Starter</h1><p>Your Vibrail project is ready.</p>\", \"text/html\"));\napp.Run();\n",
    },
  },
