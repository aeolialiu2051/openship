...
export const domain = pgTable(
  "domain",
  {
    ...
    /**
     * DNS record ownership metadata. Custom-domain cleanup only removes a
     * Cloudflare record after a successful Vibrail-managed upsert marked this
     * row, avoiding deletion of unrelated manually-managed records.
     */
