...
export const stopCommand = new Command("stop")
  ...
  .action(() => {
    ...
    try {
      ...
      // on the next boot, so a later `vibrail up` isn't blocked by a stale lock.
