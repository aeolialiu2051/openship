---
title: Teams & members
description: Invite other people into your Vibrail workspace, give them the right role, and understand the difference between your personal space and a shared team.
---

import { Step, Steps } from 'fumadocs-ui/components/steps';

Vibrail starts out as a space for one person: you. But most real work happens with other people —
...
- A Vibrail account with a workspace you can see in the dashboard.
...
Press **Send invite**. Vibrail emails that address a link to join this organization. The new person
...
<Callout title="Self-hosting Vibrail?" type="info">
On a self-hosted install you'll also see a **Send via** choice in the invite window: **Your mail
server** (the mail server you run yourself) or **Vibrail Cloud**. Pick "Your mail server" only if
you've set one up; otherwise "Vibrail Cloud" sends the invite for you. On Vibrail Cloud this choice
doesn't appear — invites always go out for you.
</Callout>

## What each role can do

A role is just a bundle of permissions. Vibrail has four, from most powerful to least:
...
- **Admin** — everything a member can do, **plus** manage members (send and cancel invites, remove
  people). On Vibrail Cloud, admins can also manage billing.
...
**remove** a member with the trash icon; Vibrail asks you to confirm first. You can't change or
remove yourself.
</Callout>
...
deploys. Because of that, Vibrail shows a **confirmation** that spells out exactly what the new access
...
address the invite was sent to** — Vibrail checks that they match.
...
with **Decline** and **Accept** buttons. Press **Accept**. You'll see **You're in**, and Vibrail
...
Every Vibrail workspace is called an **organization**. When you first sign up, Vibrail creates a
...
- **Create a separate team organization.** A clean, shared space that stays isolated from your
  ...
  team organization** card — press **Create team**, give it a name, and Vibrail switches you into the
...
but haven't set one up, switch the invite to **Vibrail Cloud** and send again. The invitee can also
...
<Cards>
  <Card title="Permissions & roles" href="/docs/security/permissions" description="The full picture of how Vibrail decides who can do what, including per-resource grants." />
