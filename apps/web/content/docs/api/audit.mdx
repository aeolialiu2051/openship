---
title: Audit API
description: Read the append-only audit log for your organization — who did what, when — with cursor or page pagination and filters.
---
...
vibrail api /audit -q eventType=deployment.failed -q limit=50
```
