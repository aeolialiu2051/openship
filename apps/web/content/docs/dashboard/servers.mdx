---
title: Servers
description: Add your own servers over SSH, let Openship install what a deployment needs, and manage each server's health, exposed ports, port forwarding, and a live terminal.
---
