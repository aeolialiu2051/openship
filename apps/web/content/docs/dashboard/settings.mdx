...
off, the server falls back to its own git login, a stored token, the public path, or cloning on Openship
...
Connect AI agents (Codex, ChatGPT Desktop, Claude, Cursor, VS Code, Windsurf, …) to your Openship API over the Model Context
