---
title: The dashboard
description: A tour of the Vibrail dashboard — the sidebar that navigates everything, the home overview, and a map to each area.
---
...
At the very top you get the **Vibrail** logo and name, plus two small buttons:
...
| Settings | **Billing** | `/billing` | Plan and usage — shown on Vibrail Cloud (or a cloud-connected instance). See [Billing](/docs/dashboard/billing). |
...
The sidebar adapts to your instance. **Billing** shows only on Vibrail Cloud or a self-hosted instance
...
<Cards>
  ...
  <Card title="Billing" href="/docs/dashboard/billing" description="Plan and usage on Vibrail Cloud." />
</Cards>
