...
description: A gentle, screen-by-screen walkthrough of putting one real GitHub app online with Vibrail — and what "live" actually looks like.
---

import { Step, Steps } from 'fumadocs-ui/components/steps';

You're about to take some code that lives on GitHub and turn it into a real website that anyone can open. Think
of it like handing a letter to the post office: you give Vibrail your code, it does the sorting, stamping, and
...
- Vibrail is up and running (you can see the dashboard). If not, start with [Installation](/docs/getting-started/installation).
- You have a **GitHub repository** with an app in it — a website, an API, anything.
- You do **not** need Docker, a server config, or any special files. Vibrail figures those out by reading your repo.
</Callout>
...
If this is your very first time, Vibrail won't have permission to see your repos yet — you'll see a **Connect
...
Find your app in the list and click it. Vibrail reads the repo, works out what kind of app it is, and takes
...
Depending on how you're running Vibrail, it may first ask **"Where do you want to deploy?"** The choices are
things like one of your **connected servers** or **Vibrail Cloud** (the managed option, where Vibrail runs the
app for you).

If Vibrail already knows where to send your app — there's only one place available, or you chose one the last
...
This is the one screen worth a slow look. Vibrail has already filled it in for you by reading your code:
...
Press **Visit Site** and Vibrail opens that address in a new tab — that's your app, on the internet, for real. 🎉

<Callout title="Where does the web address come from?" type="info">
Vibrail gives every project a web address automatically — you'll see the exact one on the setup screen and again
...
Your GitHub connection didn't finish, or Vibrail wasn't granted access to that repo. Connect again, and when
