...
description: How a self-hosted instance talks to Vibrail Cloud without leaking local identity — proxied requests carry the owner's cloud session and nothing else.
---

When you connect the copy of Vibrail you run yourself to Vibrail Cloud, the two
...
- **Self-hosted instance** — the Vibrail you run on your own machine or server.
...
- **Vibrail Cloud** — the hosted control plane at `https://vibrail.warpgateapi.com/dashboard`. It is the
...
| `Host` / the original origin | The request is re-addressed to `vibrail.warpgateapi.com`. |
