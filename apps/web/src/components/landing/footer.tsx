...
const footerLinks = {
  ...
  Developers: [
    { label: "CLI Reference", href: "https://docs.vibrail.warpgateapi.com/#/docs/cli" },
    { label: "API Reference", href: "https://docs.vibrail.warpgateapi.com/#/docs/api" },
    { label: "Architecture", href: "https://docs.vibrail.warpgateapi.com/#/docs/concepts" },
    { label: "Security", href: "https://docs.vibrail.warpgateapi.com/#/docs/mcp" },
  ],
  Company: [
