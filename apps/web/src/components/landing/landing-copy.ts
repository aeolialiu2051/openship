...
export const landingCopy = {
  en: {
    ...
    hero: {
      ...
      description: "Turn code created by you or your coding agents into a live, secure service on Vibrail Cloud or a Linux VPS — without slowing down to become an infrastructure expert.",
  ...
  zh: {
    ...
    hero: {
      ...
      title: "让软件交付跟上",
      accent: "灵感出现的速度。",
      description: "将你或 coding agent 创建的代码，部署为运行在 Vibrail Cloud 或 Linux VPS 上的安全服务，无需先成为基础设施专家。",
      primary: "部署第一个应用",
      secondary: "阅读文档",
