...
const DESCRIPTION =
  "Send and receive on your own domains without a third-party SMTP provider. Built into Vibrail - unlimited domains, unlimited mailboxes, Apache 2.0 open source.";
...
const serviceLd = {
  ...
  description: DESCRIPTION,
  url: "https://vibrail.warpgateapi.com/mail",
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Mail", item: "https://vibrail.warpgateapi.com/mail" },
  ],
};
