...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    category: "Connect",
    tagline: "Focused per-route safeguards managed from the dashboard.",
    icon: ShieldAlert,
    screenshot: null,
    summary:
      "Configure per-route rate limits, IP allowlists, and in-flight request caps from the dashboard.",
    body: [
      "Rules are stored with the project and applied through Traefik middleware on the next deployment. Available on self-hosted routes today.",
      "Build a focused policy per route and edit it from the dashboard.",
    ],
    highlights: [
      { title: "Per-route policies", desc: "Rate limits, IP allowlists, and in-flight request caps." },
      { title: "Deployment-safe", desc: "Rules are rendered into the route's Traefik configuration." },
