...
export const alt = "Vibrail Roadmap - where the open-source deployment platform is going";
export const size = OG_SIZE;
export const contentType = "image/png";

// Violet accent for the "future / roadmap" feel — same clean vibrail layout,
