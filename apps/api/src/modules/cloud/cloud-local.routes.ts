...
r.get("/status", { tag: "cloud:read", mcp: { description: "Vibrail Cloud connection status for this instance." } }, local.status);

r.get("/workspaces", { tag: "cloud:read", mcp: { description: "List the org's Vibrail Cloud (Oblien) workspaces." } }, local.listWorkspaces);
