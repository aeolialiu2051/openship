...
const envSchema = z.object({
  ...
  /** Stripe Price IDs for standard and promotional Pro subscriptions. */
  STRIPE_PRICE_PRO_MONTHLY_ID: z.string().default(""),
  STRIPE_PRICE_PRO_ANNUAL_ID: z.string().default(""),
  STRIPE_PRICE_PRO_MONTHLY_PROMOTIONAL_ID: z.string().default(""),
  STRIPE_PRICE_PRO_ANNUAL_PROMOTIONAL_ID: z.string().default(""),
