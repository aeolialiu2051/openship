...
/**
 * `isNonPublicHost` is the guard that stops a free `.vibrail.app` route from being
...
describe("isNonPublicHost", () => {
  ...
  it("allows real public hosts", () => {
    for (const h of ["ops.example.com", "203.0.113.10", "8.8.8.8", "myapp.vibrail.app", "172.32.0.1"]) {
