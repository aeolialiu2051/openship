...
const CAPABILITY_MESSAGE: Record<CloudCapability, string> = {
  ...
  "managed-project-domain":
    "Connect Vibrail Cloud to use a free subdomain — free *.vibrail.app domains route through the Vibrail Cloud edge. Add a custom domain instead, or connect Cloud in Settings.",
  "managed-compose-domains":
    "Connect Vibrail Cloud to expose services on free *.vibrail.app subdomains — they route through the Vibrail Cloud edge. Use custom domains instead, or connect Cloud in Settings.",
