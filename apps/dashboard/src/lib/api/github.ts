...
export const githubApi = {
   ...
   *   - "oauth" → force the Vibrail GitHub App install flow (even if gh CLI
   *     is already authenticated). Used by the "Connect Vibrail GitHub App"
   ...
   *   - "oauth" → remove the Vibrail GitHub App / OAuth account row
